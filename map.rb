class Map
  ...
  def initialize(canvas)
    @canvas         = canvas
    @ground         = [[-2500, -1000, -2500, 550], [-2500, 550, -1500, 550],[-1500, 550, -500, 150], [-500, 150, 0, 550], [0, 550, 350, 550], [350, 550, 500, 300], [500, 300, 800, 300], [800, 300, 1200, 400], [1200, 400, 2200, 400], [2200, 400, 2200, -1000]]
    @lines          = []
    @offset         = 0.0
    @offset_speed   = 0.0
    @current_offset = 0.0
